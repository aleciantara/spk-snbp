...
<div class="main-content" style="min-height: 535px;">
    <section class="section">
        ...
        <div>
            <form method="POST" action="{{ route('prestasi.store') }}" class="needs-validation" enctype="multipart/form-data" novalidate="">
                @csrf
                <div class="card">
                            ...
                            <div class="row m-4">
                                ...
                                <div class="form-row col-md-10">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        @elseif (!$siswa)
                                        <div style="margin-bottom:10px" id="baris-0" class="position-relative">
                                ...
                                <div class="form-row col-md-10">
                                    ...
                                    <div class="form-group col-sm-2">
                                        <input type="text" class="form-control" oninput="evaluateExpression(this)" id="poin" name="poin" >
