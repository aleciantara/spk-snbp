                ...
                <div class="card-body p-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="mipa-table">
                            @include('partials.spkKriteriaTable', ['siswas' => $siswasMIPA, 'peminatan' => 'MIPA', 'rank' => $startRankMIPA] )
                        </div>
                        <div class="tab-pane fade" id="ips-table">
                            @include('partials.spkKriteriaTable', ['siswas' => $siswasIPS, 'peminatan' => 'IPS', 'rank' => $startRankIPS])
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mb-0 pb-0">
                    <div class="form-group">
                        <div class="row mb-2">
                            <div class="col">
                                <p style="margin-bottom: 0; ">Setting Kuota SNBP:</p>
                            </div>
                        </div>
                        <div class="row mb-2">
                            @foreach($kuotaSnbps as $kuota)
